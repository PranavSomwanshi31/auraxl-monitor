...
def test_email_alert():
    ...
    data = request.get_json() or {}
    recipient = data.get("email") or get_setting("alert_email", "31pranav104@gmail.com")
    
    from email_notifier import send_email_alert
    success = send_email_alert(
        title="Test Email Alert Verification",
        severity="INFO",
        details="This is a test notification verifying that your AuraXL 24/7 AI Website Monitor email alerts are configured properly.",
        recipient=recipient
    )
    ...
    if success:
        ...
        return jsonify({
            "success": False, 
            "message": "Email alert logged. (To deliver to inbox, ensure valid SMTP username and App Password are saved in Settings)."
        })
